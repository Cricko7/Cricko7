...
- Мне `23` года `(07.09.2003)`;
- Студент **СКФ МТУСИ**. Обучаюсь по специальности **"Защищённые инфокоммуникационные сети и системы"**;
...
<p>
  <img src="images/photo_2026-04-05_08-52-14.jpg" alt="Главный экран Resume Vizor" width="32%" />
  <img src="images/photo_2026-04-05_08-54-44.jpg" alt="Пользовательский сценарий Resume Vizor" width="32%" />
  <img src="images/photo_2026-04-05_09-09-47.jpg" alt="Рабочий экран Resume Vizor" width="32%" />
</p>
  
</details>

### Проект 2 — [Веб-платформа алгоритмов "Дейкстры и Уоршелла"](https://github.com/Cricko7/maths_digital_dj-warsh)

Этот проект — учебное веб-приложение, созданное для визуализации и сравнения двух классических алгоритмов теории графов: алгоритма Дейкстры и алгоритма Уоршелла. Разработан в рамках курса высшей математики и демонстрирует их работу на наглядных интерактивных примерах.

Ключевые возможности:

1) Алгоритм Дейкстры — находит кратчайший путь от заданной вершины до всех остальных во взвешенном графе с неотрицательными весами.

2) Алгоритм Уоршелла — строит транзитивное замыкание графа (булеву матрицу достижимости), показывая все пары связанных вершин.

Технологии:
- Язык: `Python 3.12`
- Веб-фреймворк: `Flask`
- Интерфейс: `HTML + CSS` (адаптивный дизайн)
...
<p>
  <img src="gif/gifka2.gif" alt="Уоршелл" width="32%" />
  <img src="gif/gifka11.gif" alt="Дейкстра" width="32%" />
</p>
...
- Проект позволил мне получить дополнительные баллы по высшей математике за успешную реализацию и демонстрацию алгоритмов.

- Проект был разработан полностью самостоятельно: от математического обоснования до интерфейса.

- Сайт работает даже на OS `Windows 11`, результат был получен в изолированном виртуальном окружении.

> 📌 Проект открыт для изучения и доработок. Если у вас есть идеи или вопросы — создавайте Issue или пишите мне в личные сообщения.
